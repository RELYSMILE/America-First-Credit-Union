...
import {
  TrustSection, SolutionsGrid, MobileShowcase, SecuritySection,
  InsightsSection, Testimonials, FAQSection, FinalCTA
} from '@/components/HomeSections';
import {
  ShieldCheck, TrendingUp, Globe2, Sparkles, BadgeCheck, Activity,
  Smartphone, Brain, Lock, Zap, PiggyBank, Headphones, Briefcase
} from 'lucide-react';
