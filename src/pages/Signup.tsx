    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-red-50 dark:from-slate-950 dark:via-slate-950 dark:to-slate-900 flex items-center justify-center p-4 sm:p-8">
      <div className="w-full max-w-2xl">
        ...
        <div className="flex items-center gap-2.5 mb-8">
          <div
            className="w-10 h-10 rounded-xl flex items-center justify-center overflow-hidden shadow-lg shadow-blue-500/20"
          >
            {settings?.avatar ? (
              <img
                src={settings.avatar}
          ...
          <span className="text-2xl font-black text-slate-900 dark:text-white">
            {settings?.app_name?.split(' ')[0] ?? 'NEST'}
            <span className="text-[#0b24f3]">
              {settings?.app_name?.includes(' ') ? settings.app_name.split(' ')[1] : 'BANK'}
            </span>
          </span>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-black/50 p-6 sm:p-10 border border-slate-100 dark:border-slate-800">
          {step === 1 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="space-y-4 text-slate-900 dark:text-white placeholder:text-slate-400">
